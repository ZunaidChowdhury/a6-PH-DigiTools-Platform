        ...
        <div className='w-full py-10 tablet:py-30 bg-brand-gradient'>
            <div className='max-w-300 mx-auto px-4 xl:px-0'>
                ...
                <div className='text-center'>
                    <h3 className='text-white text-[2.5rem] tablet:text-[3rem] font-extrabold mb-4 leading-tight'>Ready to Transform Your Workflow?</h3>
                ...
                {/* section content */}
                {/* buttons container */}
                <div className='mt-10 flex flex-col mt:flex-row items-center justify-center gap-4'>
                ...
                <ul className='mt-10 mt:mt-4 text-white opacity-80 text-base font-normal list-disc flex flex-col mt:flex-row justify-center items-center gap-8'>
                    <li className='list-none'>14-day free trial</li>
                    <li className='list-none mt:list-disc'>No credit card required</li>
                    <li className='list-none mt:list-disc'>Cancel anytime</li>
                </ul>
            </div>
        </div>
    )
